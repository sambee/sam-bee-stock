...
public class StockInfoTest {
    ...
    // 日期
    public Long   time;
    private StockInfoTest(){}
    public static StockInfoTest getStockInfo(String stock_num)
    {
        try{
            ...
            StockInfoTest stockInfo = new StockInfoTest();
    ...
    public static void main(String[] args){
    	StockInfoTest a = StockInfoTest.getStockInfo("sz00002");
        if(a != null)
            a.printStockInfo();    
    }
}
